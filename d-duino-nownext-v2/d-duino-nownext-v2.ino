...
void setup() {
    ...
    //Oled initial I2C bus and OLED display
...
/* --------- Weather data ------------ */
  ...
  url = "/place/Norway/Hordaland/Askøy/Lindhaugen/varsel.xml";
...
host3 = host;
String url3 = "/place/Norway/Hordaland/Askøy/Lindhaugen/varsel_nu.xml";
...
if(displayView==3){
  int MAX = 12;
  for (int i = 0; i < MAX; i++ ){
    display.fillRect((i*8),(24-(rainArray[ i ]*2)), 7,  (rainArray[ i ]*2), WHITE);
  }
   display.setCursor(0,0);
   display.setTextSize(1);
